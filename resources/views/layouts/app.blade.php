...
<head>
  ...
  <title>{{ !empty($header_title) ? $header_title : ''}} - PCMS</title>
  ...
  <!-- Page Icon -->
  <link rel="icon" type="image/x-icon" href="{{ url('public/dist/img/pn-logo-small.png') }}">
...
<div class="wrapper">
  ...
  <div class="preloader flex-column justify-content-center align-items-center">
    <img class="animation__shake" src="{{ url('public/dist/img/pn-logo-small.png') }}" alt="PCMS Logo" height="60" width="60">
  </div>
